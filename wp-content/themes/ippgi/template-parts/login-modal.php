...
// Check if SWPM Social Login addon is active and Google login is enabled
$google_login_enabled = false;
if (class_exists('SWPM_SL_Utils') && method_exists('SWPM_SL_Utils', 'get_settings')) {
    $google_login_enabled = !empty(SWPM_SL_Utils::get_settings('enable_google_login'));
}
?>
    ...
    <div class="login-modal__content">
        ...
        <div class="login-modal__body">
            <?php if ($google_login_enabled) : ?>
                <!-- Google Login via direct link -->
                <a href="<?php echo esc_url(add_query_arg('swpm_social_login', 'google', home_url('/'))); ?>" class="btn btn--google btn--block">
            ...
            <?php else : ?>
                <!-- Fallback: Use SWPM login form with social login addon integration -->
